...
import com.example.laboratorio05.ui.movie.billboard.recycleview.MovieRecyclerViewAdapter
...
class BillboardFragment : Fragment() {
    ...
    private fun setRecyclerView (view: View){
        binding.billboardRecycleView.layoutManager = LinearLayoutManager(view.context)

        adapter = MovieRecyclerViewAdapter { selectedMovie ->
            showSelectedItem(selectedMovie)
        }

        binding.billboardRecycleView.adapter = adapter
        displayMovies()
    }
